...
class Runner:
    def __init__(self, model, optimizer, loss_fn, dataset, num_folds=5, batch_size=128, device='cpu'):
        self.model = model
    ...
    def train(self, train_loader, val_loader, num_epochs=10, patience=5, val_loss_target=0.05):
        ...
        for epoch in range(num_epochs):
            ...
            print(
                f'Epoch {epoch + 1}/{num_epochs} - Train accuracy: {train_accuracy:.4f}, Train Loss: {train_loss:.4f}, Validation Loss: {val_loss:.4f}')
